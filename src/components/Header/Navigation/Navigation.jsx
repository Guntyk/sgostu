      ...
      <div className="nav-wrapper">
        <div className="nav-column">
          <span className="nav-link">
            <Link to="/" onClick={() => {setOpenSideMenu(false)}}>Головна</Link>
          </span>
          <span className="nav-link">
            <Link to="/calendar" onClick={() => {setOpenSideMenu(false)}}>Календар змагань</Link>
          </span>
          <span className="nav-link">
            <Link to="/" onClick={() => {setOpenSideMenu(false)}}>Контакти</Link>
          </span>
          <span className="nav-link">
            <Link to="/" onClick={() => {setOpenSideMenu(false)}}>Зворотній зв'язок</Link>
          </span>
        </div>

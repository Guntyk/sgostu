    ...
    <article className='database'>
      <div className='database-wrapper'>
        <div className='database-text'>
          <h3 className='database-title'>{language === 'en' ? 'SGOSTU database' : 'База даних СГОСТУ'}</h3>
          <p className='database-description'>
            {language === 'en' ? 'Clubs, Trainers, Judges, Dancers' : 'Клуби, Тренери, Судді, Танцюристи'}
          </p>
          <div className='database-button-wrapper'>
            <a className='btn database-btn' href='https://app.database.dance' target='_blank' rel='norefferer noopener'>
        ...
        <div className='img-wrapper'>
          ...
          <img src={ddb_logo} alt='Dance Database Logo' className='database-logo' />
        </div>
      </div>
    </article>
  );
